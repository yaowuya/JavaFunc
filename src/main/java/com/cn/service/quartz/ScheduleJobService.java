...
import com.cn.common.quartz.result.Constant;
import com.cn.entity.quartz.ScheduleJob;
import com.cn.dao.quartz.ScheduleJobDao;
import com.cn.service.quartz.schedule.QuartzJobFactory;
...
public class ScheduleJobService {
    ...
    public void init() {
        //获取所有的定时任务
        List<ScheduleJob> scheduleJobList = scheduleJobDao.listAllJob();
    ...
    private void updateJobStatusById(ScheduleJob scheduleJob){
        scheduleJobDao.updateJobStatusById(scheduleJob);
    }
    ...
    private void updateJobCronExpressionById(ScheduleJob scheduleJob){
        scheduleJobDao.updateJobCronExpressionById(scheduleJob);
    }
    ...
    private ScheduleJob getScheduleJobByPrimaryKey(int id){
        return scheduleJobDao.getScheduleJobByPrimaryKey(id);
    }
}
