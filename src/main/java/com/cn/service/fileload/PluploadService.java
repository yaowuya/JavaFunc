...
//    private youandmeService youandmeService;
    ...
    public void upload(Plupload plupload, File pluploadDir) throws IOException {
        String fileName = "" + System.currentTimeMillis() + plupload.getName();//在服务器内生成唯一文件名
        upload(plupload, pluploadDir, fileName);
    }

    private void upload(Plupload plupload, File pluploadDir, String fileName) throws IOException {
